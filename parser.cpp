...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_EXTENDS = 9,                  /* T_EXTENDS  */
  YYSYMBOL_T_NEW = 10,                     /* T_NEW  */
  YYSYMBOL_T_AND = 11,                     /* T_AND  */
  YYSYMBOL_T_OR = 12,                      /* T_OR  */
  YYSYMBOL_T_NOT = 13,                     /* T_NOT  */
  YYSYMBOL_T_GEQ = 14,                     /* T_GEQ  */
  YYSYMBOL_T_EQ = 15,                      /* T_EQ  */
  YYSYMBOL_T_ARROW = 16,                   /* T_ARROW  */
  ...
  YYSYMBOL_T_INTCONST = 23,                /* T_INTCONST  */
  YYSYMBOL_24_ = 24,                       /* ':'  */
  YYSYMBOL_25_ = 25,                       /* '>'  */
  YYSYMBOL_26_ = 26,                       /* '+'  */
  YYSYMBOL_27_ = 27,                       /* '-'  */
  ...
  YYSYMBOL_class_list = 42,                /* class_list  */
  YYSYMBOL_class = 43,                     /* class  */
  YYSYMBOL_method_list = 44,               /* method_list  */
  YYSYMBOL_method = 45,                    /* method  */
  YYSYMBOL_parameter_list = 46,            /* parameter_list  */
  YYSYMBOL_parameter_list_nempty = 47,     /* parameter_list_nempty  */
  YYSYMBOL_parameter = 48,                 /* parameter  */
  YYSYMBOL_method_body = 49,               /* method_body  */
  ...
  YYSYMBOL_argument_list_nempty = 59,      /* argument_list_nempty  */
...
static const yytype_int8 yytranslate[] =
{
      ...
      34,    35,    28,    26,    36,    27,    38,    29,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,    24,    33,
       2,    37,    25,    39,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
{
       0,    58,    58,    61,    62,    65,    66,    73,    74,    94,
      97,    98,   101,   102,   105,   108,   111,   112,   126,   129,
     130,   133,   134,   145,   146,   147,   148,   149,   150,   151,
...
static const char *const yytname[] =
{
  ...
  "T_IF", "T_ELSE", "T_WHILE", "T_DO", "T_EXTENDS", "T_NEW", "T_AND",
  "T_OR", "T_NOT", "T_GEQ", "T_EQ", "T_ARROW", "T_INT", "T_BOOLEAN",
  "T_NONE", "T_TRUE", "T_FALSE", "T_ID", "T_INTCONST", "':'", "'>'", "'+'",
  "'-'", "'*'", "'/'", "T_UMINUS", "'{'", "'}'", "';'", "'('", "')'",
  "','", "'='", "'.'", "'?'", "$accept", "program", "class_list", "class",
  "method_list", "method", "parameter_list", "parameter_list_nempty",
  "parameter", "method_body", "declaration_list", "declaration",
  "identifier_list", "statement_list", "statement", "method_call",
  "return_statement", "expression", "argument_list",
  "argument_list_nempty", "type", "return_type", YY_NULLPTR
};
...
{
       4,     3,    27,   -94,     4,    10,   -94,   -94,   -94,     2,
      38,   -94,   -94,   -94,    39,    42,    59,   -94,    64,    38,
     203,   -94,    39,   -94,    74,    76,    79,   -94,    80,   -94,
      89,   114,    64,   -94,   -94,   129,   203,   -94,   -94,   221,
     -94,   -94,   -94,   113,   -94,   115,    54,   -94,    69,    69,
      69,   130,   208,   142,   196,   126,   138,    69,   -94,   -94,
      20,   -94,    69,    69,   -94,    73,    93,   102,   196,    69,
      69,   141,    69,   -94,   208,   -94,   -94,   136,   132,   150,
     132,   123,    69,    69,    69,    69,    69,    69,    69,    69,
      69,   -94,    69,   196,   196,   196,   128,   149,   -94,   154,
      89,    90,    82,    83,    40,    84,    85,   144,   129,    82,
       0,    92,    84,    85,     0,     0,    86,    87,    88,    89,
      90,     0,     0,    86,    87,    88,    89,    90,     0,     0,
      92,     0,     0,     0,     0,     0,     0,    92
};

static const yytype_int16 yycheck[] =
{
      46,    48,    49,    50,    68,    54,    14,    15,    54,   102,
      57,    11,     9,    28,    29,    62,    63,    25,    26,    27,
      28,    29,    68,    70,    39,    72,    22,     0,   121,    93,
      94,    39,    22,    31,    31,    82,    83,    84,    85,    86,
      87,    88,    89,    90,    44,    92,    95,    93,    94,    95,
      26,    27,    28,    29,    34,    17,    18,     3,    38,     5,
      22,     7,     8,    39,    20,    34,   115,   116,    37,   115,
     116,    17,    18,    34,    32,   122,    22,   141,   125,    10,
      36,    22,    13,    39,    11,    12,    22,    14,    15,    20,
      21,    22,    23,   140,   143,   141,    27,   143,    25,    26,
      27,    28,    29,    34,    11,    12,    33,    14,    15,    33,
      36,    32,    39,    11,    12,    35,    14,    15,    25,    26,
      27,    28,    29,    16,    31,    36,    19,    25,    26,    27,
      28,    29,    39,    31,    11,    12,    22,    14,    15,    11,
      12,    39,    14,    15,    31,    16,     4,    32,    25,    26,
      27,    28,    29,    25,    26,    27,    28,    29,    35,    33,
      22,    31,    39,    22,    36,    11,    12,    39,    14,    15,
      34,    39,    22,    34,    11,    12,    32,    14,    15,    25,
      26,    27,    28,    29,    35,    32,    35,    33,    25,    26,
      27,    28,    29,    39,    11,    12,    33,    14,    15,     3,
      32,     5,    39,     7,     8,     7,    35,    24,    25,    26,
      27,    28,    29,    11,    12,     6,    14,    15,    22,    34,
      17,    18,    39,    31,    33,    22,    32,    25,    26,    27,
      28,    29,     4,    11,    12,    33,    14,    15,    17,    18,
      19,    39,    34,    22,    32,    37,    38,    25,    26,    27,
      28,    29,    11,    12,    36,    14,    15,    35,   118,    11,
      -1,    39,    14,    15,    -1,    -1,    25,    26,    27,    28,
      29,    -1,    -1,    25,    26,    27,    28,    29,    -1,    -1,
      39,    -1,    -1,    -1,    -1,    -1,    -1,    39
};
...
{
       0,    22,    41,    42,    43,     9,    31,     0,    42,    22,
      50,    31,    17,    18,    22,    44,    45,    51,    60,    50,
      34,    32,    22,    44,    22,    52,    44,    22,    46,    47,
      48,    60,    36,    33,    32,    35,    36,    22,    52,    16,
      47,    19,    60,    61,    31,    49,    50,    32,     3,     5,
       7,     8,    22,    53,    54,    55,    10,    13,    20,    21,
      22,    23,    27,    34,    55,    57,    57,    57,    31,    34,
      37,    38,     4,    56,    22,    53,    33,    22,    57,    38,
      57,    57,    11,    12,    14,    15,    25,    26,    27,    28,
      29,    33,    39,    31,    31,    54,    57,    58,    59,    57,
      22,    57,    34,    22,    35,    57,    57,    57,    57,    57,
      57,    57,    57,    57,    57,    54,    54,    53,    36,    35,
      33,    34,    37,    33,    58,    24,    53,    53,    32,    59,
      58,    57,    35,    57,    32,    32,     7,    35,    33,     6,
      34,    31,    57,    54,    35,    53,    33,    32
};
...
#line 1539 "parser.cpp"
  ...
  case 6: /* class: T_ID T_EXTENDS T_ID '{' declaration_list method_list '}'  */
#line 66 "parser.y"
...
#line 1569 "parser.cpp"
  ...
  case 11: /* parameter_list: parameter_list_nempty  */
#line 98 "parser.y"
                                       { (yyval.parameter_list_ptr) = (yyvsp[0].parameter_list_ptr); }
#line 1575 "parser.cpp"
    break;

  case 12: /* parameter_list_nempty: parameter  */
#line 101 "parser.y"
...
#line 1581 "parser.cpp"
  ...
  case 13: /* parameter_list_nempty: parameter ',' parameter_list_nempty  */
#line 102 "parser.y"
...
#line 1623 "parser.cpp"
  ...
  case 20: /* identifier_list: T_ID ',' identifier_list  */
#line 130 "parser.y"
...
#line 1653 "parser.cpp"
  ...
  case 25: /* statement: method_call ';'  */
#line 147 "parser.y"
                               { (yyval.statement_ptr) = new CallNode((yyvsp[-1].methodcall_ptr)); }
#line 1659 "parser.cpp"
    break;

  case 26: /* statement: T_IF expression '{' statement statement_list '}'  */
#line 148 "parser.y"
                                                                      { (yyvsp[-1].statement_list_ptr)->push_front((yyvsp[-2].statement_ptr)); (yyval.statement_ptr) = new IfElseNode((yyvsp[-4].expression_ptr),(yyvsp[-1].statement_list_ptr),new std::list<StatementNode*>()); }
#line 1665 "parser.cpp"
    break;

  case 27: /* statement: T_IF expression '{' statement statement_list '}' T_ELSE '{' statement statement_list '}'  */
#line 149 "parser.y"
...
#line 1671 "parser.cpp"
  ...
  case 28: /* statement: T_WHILE expression '{' statement statement_list '}'  */
#line 150 "parser.y"
...
#line 1677 "parser.cpp"
  ...
  case 29: /* statement: T_DO '{' statement statement_list '}' T_WHILE '(' expression ')' ';'  */
#line 151 "parser.y"
...
#line 1683 "parser.cpp"
  ...
  case 30: /* statement: T_PRINT expression ';'  */
#line 152 "parser.y"
                                   { (yyval.statement_ptr) = new PrintNode((yyvsp[-1].expression_ptr)); }
#line 1689 "parser.cpp"
    break;

  case 31: /* method_call: T_ID '.' T_ID '(' argument_list ')'  */
#line 155 "parser.y"
...
#line 1743 "parser.cpp"
  ...
  case 40: /* expression: expression T_GEQ expression  */
#line 168 "parser.y"
                                                { (yyval.expression_ptr) = new GreaterEqualNode((yyvsp[-2].expression_ptr),(yyvsp[0].expression_ptr)); }
#line 1749 "parser.cpp"
    break;

  case 41: /* expression: expression T_EQ expression  */
#line 169 "parser.y"
...
#line 1767 "parser.cpp"
  ...
  case 44: /* expression: T_NOT expression  */
#line 172 "parser.y"
                                                { (yyval.expression_ptr) = new NotNode((yyvsp[0].expression_ptr)); }
#line 1773 "parser.cpp"
    break;

  case 45: /* expression: expression '?' expression ':' expression  */
#line 173 "parser.y"
...
#line 1845 "parser.cpp"
  ...
  case 57: /* argument_list: argument_list_nempty  */
#line 187 "parser.y"
                                                { (yyval.expression_list_ptr) = (yyvsp[0].expression_list_ptr); }
#line 1851 "parser.cpp"
    break;

  case 58: /* argument_list_nempty: expression ',' argument_list_nempty  */
#line 190 "parser.y"
...
#line 1857 "parser.cpp"
  ...
  case 59: /* argument_list_nempty: expression  */
#line 191 "parser.y"
